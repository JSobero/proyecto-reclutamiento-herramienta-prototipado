...
El modelado del proceso de negocio permite representar de manera estructurada y visual las actividades involucradas en el 
“Concurso de Personal” de Tambo. A través de la notación UML, se identifica la interacción entre actores externos, trabajadores internos, flujos de información y documentos clave.
...
\begin{itemize}
    ...
    \item \item \textbf{Descontrol en la inducción}: Ausencia de un registro formal y centralizado que indique cuándo un nuevo ingreso finaliza su etapa de entrenamiento en tienda (Trainee) y está listo para asumir el puesto al 100\%.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Integración del Trainee}: Trazabilidad de la etapa de entrenamiento práctico en tienda, asegurando que el nuevo ingreso cumpla con su capacitación operativa antes de cambiar su estado a Colaborador Activo.
\end{itemize}
